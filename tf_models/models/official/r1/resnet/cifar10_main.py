...
from fs_coding import replace_relu_with_fs, print_spikes
...
def define_cifar_flags():
  ...
  flags.DEFINE_bool("use_fs", False, "Use FS coding for Relu")
  flags.DEFINE_bool("print_spikes", False, "Print sum of spikes of fs-neurons")
