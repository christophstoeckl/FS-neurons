...
def define_cifar_flags():
    ...
    flags_core.set_defaults(data_dir='/calc/stoeckl/binary_populations/tf_models/models/official/vision/image_classification/CIFAR10/cifar-10-batches-bin',
                            model_dir='/calc/stoeckl/binary_populations/checkpoints/test',
                            train_epochs=182,
